...
void FACELIBSHARED_EXPORT protobuf_AddDesc_common_2eproto();
...
class FACELIBSHARED_EXPORT Common : public ::google::protobuf::Message {
 public:
  Common();
  virtual ~Common();
 ...
 private:
  ...
  friend void FACELIBSHARED_EXPORT protobuf_AddDesc_common_2eproto();
